...
\large Project Proposal for Software Engineering -- UCS503P}
\author{
...
time-to-discovery). As a web-based application project, it remains focused on engineering workflow, usability, and scalability readiness rather than research-driven novelty.
